                        ...
                        <div class="col-lg-4">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <img src="./assets/img/inventory-logo.png"
                                    style="width: 200px; margin-left: 25%; margin-top: 5%">
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            ...
                                            <button class="btn btn-success btn-lg btn-block rounded-pill" tabindex="15"
                                                style="font-size: medium; margin: auto" name="login">🔐 <b>Log
                                                    In</b></button>
                                            <a href="index.php" class="btn btn-outline-success btn-lg rounded-pill"
                                                style="font-size: medium; margin: auto;"><b>Kembali</b></a>
                                        </div>
                                    </form>
                                </div>
