                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="template-users.csv" class="btn btn-secondary rounded-pill" download>Template
                                CSV</a>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $img; ?></td>
                                        <td><strong><a
                                                    href="detail.php?id=<?= $idp; ?>"><?= $nama_peralatan; ?></a></strong>
                                        </td>
                                        <td><?= $deskripsi; ?></td>
                                        <td><?= $stok; ?></td>
                                        <td>
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="text" name="nama_peralatan"
                                                            value="<?= $nama_peralatan; ?>" class="form-control"
                                                            required>
                                                        <br>
                                                        ...
                                                        <br>
                                                        <input type="file" name="file" value="<?= $gambar; ?>"
                                                            class="form-control">
                                                        <br>
                                                        <input type="hidden" name="idp" value="<?= $idp; ?>">
                                                        <button type="submit" class="btn btn-warning"
                                                            name="updateperalatan"><b>Update</b></button>
                                    ...
                                    <div class="modal fade" id="uploadCSVModal" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="upload_csvstok.php" method="POST"
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <button type="submit" class="btn btn-danger"
                                                            name="hapusperalatan"><b>Hapus</b></button>
                                                        <button type="button" class="btn btn-success"
                                                            data-dismiss="modal"><b>Close</b></button>
                                                    </div>
                                                </form>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="text" name="nama_peralatan" placeholder="Nama Peralatan" class="form-control"
                            required>
                        <br>
                        <input type="text" name="deskripsi" placeholder="Deskripsi Peralatan" class="form-control"
                            required>
                        <br>
